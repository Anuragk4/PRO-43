class Security{
    ...
    display(){
        this.button1.mousePressed(()=>{
            if(system.authenciate(accessCode1,this.access1.value())){
                this.button1.hide()
                this.access1.hide()
                score++;
            }
        ...
        this.button2.mousePressed(()=>{
            if(system.authenciate(accessCode2,this.access2.value())){
                this.button2.hide()
                this.access2.hide()
                score++;
            }
        ...
        this.button3.mousePressed(()=>{
            if(system.authenciate(accessCode3,this.access3.value())){
                this.button3.hide()
                this.access3.hide()
                score++;
            }
